!(() => {
	...
	var r,
		...
		f = s ? c.bind(c) : () => c.apply(c, arguments),
		...
		L = (t, e) =>
			arguments.length < 2 ? (T((r = i[t])) ? r : void 0) : i[t] && i[t][e],
		U = b({}.isPrototypeOf),
		N = i.navigator,
		C = N && N.userAgent,
		_ = C ? String(C) : "",
	...
	var re,
		...
		we = (t, e) => {
			...
			while (e.length > o) ut(n, (r = e[o++])) && (~me(i, r) || be(i, r));
			return i;
		},
		Se = [
			"constructor",
	...
	var or = (t) => {
		...
		ir = or(or.bind),
		ar = (t, e) => (
			J(t), void 0 === e ? t : s ? ir(t, e) : () => t.apply(e, arguments)
		),
	...
	var ta = _i.trim,
		...
		oa = na && na.iterator,
		ia =
			1 / ra(Mi + "-0") != Number.NEGATIVE_INFINITY ||
			(oa &&
				!a(() => {
					ra(Object(oa));
				}))
	...
	var Ea = Function.prototype,
		...
		Ra =
			...
			(s ? xa.bind(Oa) : () => xa.apply(Oa, arguments)),
		Pa = !a(() => {
			Reflect.apply(() => {});
		});
	Ce(
	...
	var qc = TypeError,
		...
		$c = function (t) {
			var e = Wr(j(this)),
				r = "",
				n = ce(t);
			if (n < 0 || Number.POSITIVE_INFINITY === n)
	...
	var kp = Object.getOwnPropertyDescriptor,
		...
		lv = (t, e) => {
			var r = uv(t, e, e + 2);
			return sv(fv, r) ? Zp(r, 16) : Number.NaN;
		},
		hv = (t) => {
					...
					case wg:
						if (
							...
							if (
								...
								while (this.path.length > 1 && "" === this.path[0])
									Ad(this.path);
							"?" === o
								? ((this.query = ""), (c = Eg))
			...
			dn
				...
				void 0 !== e &&
					_t(
						...
						"message",
						((t, e) =>
							void 0 === t ? (arguments.length < 2 ? "" : e) : Wr(t))(e),
					),
				(i = r),
				(a = r.stack),
				Zg &&
